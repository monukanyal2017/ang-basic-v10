...
export class AuthService {
    ...
    login(email: string, password: string) {
        ...
        return this.http.post<any>('/api/user/login', login_data, { observe: 'response', responseType: 'json', headers: header }).pipe(map((res) => { console.log(res.body); return res.body; }));
    }
    ...
    private authSuccessfully() {
        ...
        // console.log('setsession'+localStorage.getItem('id_token'));
    ...
    signup(user: any) {
        ...
        return this.http.post<any>('/api/user/register', login_data, { observe: 'response', responseType: 'json', headers: header }).pipe(map(res => { console.log(res.body); return res.body; }), catchError(this.handleError));
    }
